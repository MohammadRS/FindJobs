...
namespace FindJobs.Domain.Dtos
{
    public class ApplicantDto
    {
        ...
        public bool IsWorkFromHome { get; set; } = false;
        public bool IsPartialworkfromhome { get; set; } = false;
        ...
        public virtual List<ApplicantDocumentsDto> ApplicantDocuments { get; set; }
