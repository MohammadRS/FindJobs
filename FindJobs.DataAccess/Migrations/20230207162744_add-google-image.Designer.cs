...
namespace FindJobs.DataAccess.Migrations
{
    ...
    [Migration("20230207162744_add-google-image")]
    partial class addgoogleimage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.Applicant", b =>
                {
                    ...
                    b.Property<string>("ApplicantGoogleImage")
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.ApplicantOfferRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApplicantOfferRequest");
                });

            modelBuilder.Entity("FindJobs.DataAccess.Entities.ApplicantOffersFavourite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApplicantOffersFavourites");
                });
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.OfferDocuments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("ApplicantOfferRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApplicantOfferRequestId");
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.OfferJobCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.ApplicantOfferRequest", b =>
                {
                    b.HasOne("FindJobs.DataAccess.Entities.Applicant", "Applicant")
                        .WithMany("ApplicantOfferRequests")
                        .HasForeignKey("ApplicantEmail")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.ApplicantOffersFavourite", b =>
                {
                    b.HasOne("FindJobs.DataAccess.Entities.Applicant", "Applicant")
                        .WithMany("ApplicantOffersFavourites")
                        .HasForeignKey("ApplicantEmail");
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.City", b =>
                {
                    b.HasOne("FindJobs.DataAccess.Entities.Country", null)
                        .WithMany("Cities")
                        .HasForeignKey("CountryCode");
                });
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.OfferDocuments", b =>
                {
                    b.HasOne("FindJobs.DataAccess.Entities.ApplicantOfferRequest", null)
                        .WithMany("OfferDocuments")
                        .HasForeignKey("ApplicantOfferRequestId");

                    b.HasOne("FindJobs.DataAccess.Entities.ApplicantDocuments", "Document")
                        .WithMany("OfferDocuments")
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.OfferJobCategory", b =>
                {
                    b.HasOne("FindJobs.DataAccess.Entities.JobCategory", "JobCategory")
                        .WithMany("OfferJobCategories")
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.Applicant", b =>
                {
                    ...
                    b.Navigation("ApplicantOfferRequests");

                    b.Navigation("ApplicantOffersFavourites");
            ...
            modelBuilder.Entity("FindJobs.DataAccess.Entities.JobCategory", b =>
                {
                    b.Navigation("OfferJobCategories");
                });
